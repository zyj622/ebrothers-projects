...
public class LevelSelector extends CCSprite {
	...
	public static LevelSelector levelSprite(int level,int score,boolean isNomal){
		if(score == 0){
			...
			if(isNomal){
				...
				return new LevelSelector("stage_bg_pressed.png","stage_2.png","stage_2.png","stage_2.png",level);
			}
		}
		return null;
	}
	...
	public LevelSelector(String fileName,String star01,String star02,String star03,int level) {
		super(CCSpriteFrameCache.sharedSpriteFrameCache().getSpriteFrame(
				fileName));
		//initSprite();
		setAnchorPoint(1, 1);
		CGSize cs = getContentSizeRef();
//		Logger.e("game", "level===="+String.valueOf(cs.width)+"---"+String.valueOf(cs.height));
		CCSpriteFrameCache cache = CCSpriteFrameCache.sharedSpriteFrameCache();
		
		CCSpriteFrame spriteFrame1 = cache.getSpriteFrame(String.format("stage_leve%d.png", level));
	...
	//	Logger.e("game", "stage=="+String.valueOf(stageCs.width)+"---"+String.valueOf(stageCs.height));
		sprite2.setPosition((cs.width-stageCs.width*3)/2, stageCs.height*0.7f/2);
		addChild(sprite2);
		...
		sprite3.setPosition((cs.width-stageCs.width*3)/2+stageCs.width, stageCs.height*1.1f/2);
		addChild(sprite3);
		...
		sprite4.setPosition((cs.width-stageCs.width*3)/2+stageCs.width*2, stageCs.height*1.5f/2);
		addChild(sprite4);
	}
