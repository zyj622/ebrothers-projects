...
public abstract class Camera {
	...
	public void unproject (Vector3 vec, float viewportX, float viewportY, float viewportWidth, float viewportHeight) {
		...
		x = x - viewportX;
		y = CCDirector.sharedDirector().winSize().height - y - 1;
		y = y - viewportY;
	...
	public void unproject (Vector3 vec) {
		unproject(vec, 0, 0, CCDirector.sharedDirector().winSize().width, CCDirector.sharedDirector().winSize().height);
	}
	...
	public void project (Vector3 vec) {
		project(vec, 0, 0, CCDirector.sharedDirector().winSize().width, CCDirector.sharedDirector().winSize().height);
	}
	...
	public Ray getPickRay (float x, float y) {
		return getPickRay(x, y, 0, 0, CCDirector.sharedDirector().winSize().width, CCDirector.sharedDirector().winSize().height);
	}
}
