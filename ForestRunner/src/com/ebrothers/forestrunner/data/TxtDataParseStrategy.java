	...
	public LevelData parse(InputStream is) {
		...
		while (scanner.hasNextLine()) {
			...
			if (line.startsWith("Ground M")) {
				...
				data.width = Float.parseFloat(splites[2]) * Globals.scale_ratio;
				parent = data;
				...
				data.width = Float.parseFloat(splites[1]) * Globals.scale_ratio;
				parent = data;
				level.addSpriteData(data);
				...
				data.rx = Float.parseFloat(splites[1]) * Globals.scale_ratio;
				if (parent != null) {
